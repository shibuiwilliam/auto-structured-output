...
class TestSchemaValidator:
    ...
    def test_validate_number_constraints_valid(self) -> None:
    ...
    def test_validate_number_constraints_invalid_key(self) -> None:
    ...
    def test_validate_number_constraints_multipleOf_invalid(self) -> None:
    ...
    def test_validate_number_constraints_multipleOf_zero(self) -> None:
    ...
    def test_validate_number_constraints_both_maximum(self) -> None:
    ...
    def test_validate_number_constraints_both_minimum(self) -> None:
    ...
    def test_validate_array_constraints_valid(self) -> None:
    ...
    def test_validate_array_constraints_invalid_key(self) -> None:
    ...
    def test_validate_array_constraints_minItems_not_integer(self) -> None:
    ...
    def test_validate_array_constraints_minItems_negative(self) -> None:
    ...
    def test_validate_array_constraints_maxItems_not_integer(self) -> None:
    ...
    def test_validate_array_constraints_maxItems_negative(self) -> None:
    ...
    def test_validate_array_constraints_minItems_greater_than_maxItems(self) -> None:
    ...
    def test_validate_required_fields_not_list(self) -> None:
        """Test validation fails when required is not a list"""
        required = "name"
        properties = {"name": {"type": "string"}}

        with pytest.raises(ValueError, match="required must be a list"):
            SchemaValidator.validate_required_fields(required, properties)  # type: ignore[arg-type]

    def test_validate_required_fields_field_not_string(self) -> None:
    ...
    def test_validate_required_fields_field_not_in_properties(self) -> None:
    ...
    def test_validate_enum_not_list(self) -> None:
        """Test validation fails when enum is not a list"""
        enum_values = "active"

        with pytest.raises(ValueError, match="enum must be a list"):
            SchemaValidator.validate_enum(enum_values)  # type: ignore[arg-type]

    def test_validate_enum_empty(self) -> None:
    ...
    def test_validate_enum_duplicates(self) -> None:
